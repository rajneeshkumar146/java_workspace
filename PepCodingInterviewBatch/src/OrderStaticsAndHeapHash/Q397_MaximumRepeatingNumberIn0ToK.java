...
public class Q397_MaximumRepeatingNumberIn0ToK {
	...
	public static void solve() throws Exception {
		int[] arr = takeArrayInput(scn.scanInt());
		int k = scn.scanInt();
		int ans = MaximumRepeating(arr, k);
		pnter.print(ans + "");
	}

	private static int MaximumRepeating(int[] arr, int k) {

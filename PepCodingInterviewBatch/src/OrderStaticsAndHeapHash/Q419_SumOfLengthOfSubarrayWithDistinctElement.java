...
public class Q419_SumOfLengthOfSubarrayWithDistinctElement {
	...
	public static void solve() throws Exception {
		...
		int ans = SubarrayWithDistinctElement(arr);
		pnter.print(ans + "");

	}

	private static int SubarrayWithDistinctElement(int[] arr) {
		int length = 0;

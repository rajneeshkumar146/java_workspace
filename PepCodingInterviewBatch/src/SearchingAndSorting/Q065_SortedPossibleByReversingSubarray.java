...
public class Q065_SortedPossibleByReversingSubarray {
	...
	public static void solve() throws Exception {
		...
		boolean res = CheckSortingByReversing(arr, n);

		pnter.print(res + "");

	}

	private static boolean CheckSortingByReversing(int[] arr, int n) {
		int st = 0;
		int end = 0;

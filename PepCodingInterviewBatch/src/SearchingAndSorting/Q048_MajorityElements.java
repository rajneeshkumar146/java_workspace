...
public class Q048_MajorityElements {
	...
	public static void main(String[] args) throws Exception {
		...
		int Majorityele = MajorityElements(arr, n);
		boolean result = checkMajority(arr, n, Majorityele);

		pnter.print((result ? Majorityele : "No Majority Element") + "");
	...
	private static boolean checkMajority(int[] arr, int n, int Majorityele) {
		int count = 0;
		for (int i = 0; i < n; i++) {
			if (arr[i] == Majorityele) {
				count++;

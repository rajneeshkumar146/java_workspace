...
public class Q049_SearchingInArrayAdjacentDifferByK {
	...
	public static void solve() throws Exception {
		...
		int index = search(arr, n, ele, k);
		pnter.print(index + "");
	}

	private static int search(int[] arr, int n, int ele, int k) {
		int index = -1;
		...
		for (int i = 0; i < n; i++) {
			...
			int jumpFactor = Math.abs((ele - arr[i])) / k;
			i += jumpFactor;
		}
		return index;
	}

...
public class Q075_permutetwoSubArrays {
	...
	public static void solve() throws Exception {
		...
		int n = scn.scanInt();
		int[] arr1 = takeArrayInput(n);
		int[] arr2 = takeArrayInput(n);
		int k = scn.scanInt();
		boolean res = permute(arr1, arr2, n, k);

		pnter.print(res + "");
	}

	private static boolean permute(int[] arr1, int[] arr2, int n, int k) {

...
public class Q277_FlattingAlinkedList {
	...
	private static class LinkedList {
		...
		private void Flattering() {

			Node mainll = this.head;
			while (mainll != null) {

				Node nextnode = mainll.next;

				Node IsVertical = mainll;
				while (IsVertical.Vertical != null) {
					mainll.next = IsVertical.Vertical;
					IsVertical = IsVertical.Vertical;
					mainll.Vertical = null;
					mainll = mainll.next;
				}

				mainll.next = nextnode;
				mainll = mainll.next;

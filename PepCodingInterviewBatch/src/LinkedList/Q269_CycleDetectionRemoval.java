...
public class Q269_CycleDetectionRemoval {
	...
	public static void solve() throws Exception {
		...
		ll.makeCycle(scn.scanInt());

		boolean IsCycle = ll.IsCyclic();
		pnter.printLine(IsCycle + "");
	...
	private static class linkedList {
		...
		public void makeCycle(int index) throws IOException {
			if (index > this.size - 1) {
				pnter.print("Not Possible");
				return;
			}
		...
		public boolean IsCyclic() {
			return IsLoopPresent() == null ? false : true;
		}

		private Node IsLoopPresent() {
			Node slow = this.head;
			Node fast = this.head;
		...
		public void RemoveLoop() throws IOException {

			Node LoopNode = IsLoopPresent();

			if (LoopNode == null) {
				pnter.printLine("No Loop");
				return;
			}

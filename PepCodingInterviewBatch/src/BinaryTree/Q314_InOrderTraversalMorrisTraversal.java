...
public class Q314_InOrderTraversalMorrisTraversal {
	...
	public static void main(String[] args) throws IOException {
		...
		MorrisTraversal(nodes[0]);
		pnter.close();
	}

	private static void MorrisTraversal(Node root) throws IOException {
		Node curr = root;
		while (curr != null) {

			if (curr.left == null) {
				pnter.print(curr.data + " ");
				curr = curr.right;
			} else {
				Node pre = curr.left;
				...
				if (pre.right == null) {  //SpotToMakeTgread.
					pre.right = curr;
					curr = curr.left;
				} else {
					pre.right = null;

...
public class Q032_MinimumNumberDISequences {
	...
	public static void main(String[] args) throws Exception {
		...
		int n = 1;
		LinkedList<Integer> stack = new LinkedList<Integer>(); // AddFirst_and_removeFirst.
	...
	private static int buildNumber(LinkedList<Integer> stack, int num) {

		int sum = num;

		while (!stack.isEmpty()) {
			sum = sum * 10 + stack.removeFirst();
		}

...
public class Q030_MinSwapToMakeLessAllElementLessThanK {
	...
	public static void main(String[] args) throws Exception {
		...
		prefixArray = PrifixSumArray(0, n, prefixArray);
		int minSwap = Integer.MAX_VALUE;

		for (int i = 0, j = i + count; j <n; i++, j++) {
			int x = prefixArray[j] - prefixArray[i];
			int swap = k - x;
			if (minSwap > swap) {
				minSwap = swap;
			}
		...
		pnter.print("MinSwap is : " + minSwap);
		pnter.close();

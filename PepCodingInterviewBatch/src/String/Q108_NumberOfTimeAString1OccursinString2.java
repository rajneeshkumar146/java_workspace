...
public class Q108_NumberOfTimeAString1OccursinString2 {
	...
	public static void solve() throws Exception {
		...
		int ans = StringOneOccurenceInString2(str1, str2);
		pnter.print(ans + "");
	}

	private static int StringOneOccurenceInString2(String str1, String str2) {

		int[] AuxiArray = new int[str2.length()];

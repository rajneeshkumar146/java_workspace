...
public class Q082_PrintAllAnagrams {
	...
	private static void Anagrams(String[] arr) throws IOException {

		HashMap<String, HashSet<String>> map = new HashMap<>();

		for (String s : arr) {

			// Try_to_make_a_RunLenngthEncodedString.
			int[] freMap = new int[26];

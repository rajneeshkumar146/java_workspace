...
public class Q100_NextGreaterNumberInBinary {
	...
	public static void solve() throws Exception {
		String n = scn.scanString();

		char[] ans = nextGreaterNumber(n);
		for(char ch:ans){
			pnter.print(ch+"");
		}
	}

	private static char[] nextGreaterNumber(String str) {
		...
		SwapString(charr, i, i + 1);
		i+=2; // Increament_for_Reversing.

		reverseString(charr, i, str.length() - 1);

		return charr;

	}

	private static void SwapString(char[] arr, int i, int j) {

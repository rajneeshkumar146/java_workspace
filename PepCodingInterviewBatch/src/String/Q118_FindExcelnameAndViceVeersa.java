...
public class Q118_FindExcelnameAndViceVeersa {
	...
	private static void NumbertoAlohabate(int n) throws IOException {
		...
		pnter.print(sb.reverse().toString());

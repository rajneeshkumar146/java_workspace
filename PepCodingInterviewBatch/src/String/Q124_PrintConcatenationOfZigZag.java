...
public class Q124_PrintConcatenationOfZigZag {
	...
	public static void solve() throws Exception {
		...
		int k = scn.scanInt();
		PrintConcatenation(str, k);
	}

	private static void PrintConcatenation(String str, int k) throws IOException {

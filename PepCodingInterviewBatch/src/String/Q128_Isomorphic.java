...
public class Q128_Isomorphic {
	...
	private static boolean IsIsomorphic(String str1, String str2) throws IOException {
		...
		for (int i = 0; i < str1.length(); i++) {
			...
			if ((Map1[index1] == '\u0000' || Map1[index1] == ch2)
					&& (Map2[index2] == '\u0000' || Map2[index2] == ch1)) {
				Map1[index1] = ch2;
				Map2[index2] = ch1;
			} else {
				return false;

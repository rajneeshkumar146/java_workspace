...
public class Q104_largest_word_in_dictionary_by_deleting_some_characters_of_given_string {
	...
	public static void solve() throws Exception {
		...
		Largetword(str, dictionary);

		// Basically_we_need_to_find_longest_subsequence.

	}

	private static void Largetword(String str, String[] arr) throws IOException {
		int max = -1;
		int index = -1;

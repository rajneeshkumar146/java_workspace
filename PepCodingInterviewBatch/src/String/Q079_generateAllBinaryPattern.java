...
public class Q079_generateAllBinaryPattern {
	...
	private static void BinaryPattern(String str, String ans) throws IOException {
		if (str.length() == 0) {
			pnter.printLine(ans + "");
			return;
		}
		...
		if (ch == '?') {
			BinaryPattern(ros, ans + '0');
			BinaryPattern(ros, ans + '1');
		} else {
			BinaryPattern(ros, ans + ch);
		}

...
public class Q126_TransformString1To2InMinimumOperations {
	...
	public static void solve() throws Exception {
		...
		int ans = TransformOneToTwo(str1, str2);
		pnter.print(ans + "");
	}

	private static int TransformOneToTwo(String str1, String str2) {

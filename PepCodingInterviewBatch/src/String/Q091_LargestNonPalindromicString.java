...
public class Q091_LargestNonPalindromicString {
	...
	private static int stringLength(String str) {
		...
		if (!flag) {
			return 0; // NoStringExistWhichIsNonPalindromeIfAllCharIsEqual.
		} else if (isPalindrome(str)) { // IfStringIsPalindromeThen(n-1)StringIsLargestNonPlaindrome.
			return str.length() - 1;
		} else {
			return str.length();
		}

...
public class Q265_FirstNonRepeatingCharacter {
	...
	private static void FirstNonrepeatingChar(String str) throws IOException {

		int[] Freqmap = new int[26];
		LinkedList<Character> queue = new LinkedList<>(); // addLast_removeFirst.

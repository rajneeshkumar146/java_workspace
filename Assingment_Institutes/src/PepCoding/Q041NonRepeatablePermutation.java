...
public class Q041NonRepeatablePermutation {
	...
	public static void solve() throws Exception {
		PermutationWithoutRepeation(scn.scanString(), "");
	}

	private static void PermutationWithoutRepeation(String str, String ans) throws IOException {
		if (str.length() == 0) {
			pnter.printLine(ans);
			return;
		}
		...
		for (int i = 0; i < str.length(); i++) {
			...
			freq[ch - 'a'] = true;
			PermutationWithoutRepeation(ros, ans + ch);
		}

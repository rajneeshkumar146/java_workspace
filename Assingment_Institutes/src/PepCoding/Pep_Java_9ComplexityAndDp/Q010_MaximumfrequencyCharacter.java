package PepCoding.Pep_Java_9ComplexityAndDp;
...
public class Q010_MaximumfrequencyCharacter {
	...
	public static void solve() throws Exception {
		...
		MaximumfrequencyCharacter(str);

	}

	private static void MaximumfrequencyCharacter(String str) {

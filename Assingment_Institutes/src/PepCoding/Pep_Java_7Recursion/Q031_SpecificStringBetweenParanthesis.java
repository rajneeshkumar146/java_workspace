...
public class Q031_SpecificStringBetweenParanthesis {
...
SpecificStringBetweenParanthesis(str, "", false);
	}

	private static void SpecificStringBetweenParanthesis(String str, String ans, boolean isfind) throws IOException {
		...
		if (ch == '(' || isfind) {
			if (ch == ')') {
				SpecificStringBetweenParanthesis(str.substring(1), ans + ch, false);

			} else {
				SpecificStringBetweenParanthesis(str.substring(1), ans + ch, true);
			}
		} else {
			SpecificStringBetweenParanthesis(str.substring(1), ans, isfind);
		}

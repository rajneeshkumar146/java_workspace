...
public class Recursion_005 {
	...
	public static void main(String[] args) throws Exception {
		// 1. Lecture 12
		// 1.1 Fibonacci - RMT
		// 1.2 CountBoardPath - RMT
		// 1.3 CountMazePath - RMT
		// 1.4 Slider - Fib(Problem Statement), CBP & CMP
		// 1.5 Min Cost Path
		// 1.6 Max size sub-matrix with all 1's
		// 1.7 Goldmine
		// 1.8 Palindromic Substrings
		// 1.9 Longest Increasing Subsequence
		// 1.10 Rod Cutting
		// 1.11 Coin change - combinations, permutations
		// 1.12 Longest Bitonic Subsequence
		// 1.13 Minimum Palindromic Cut
		// 1.14 Matrix Chain Multiplication
		// 1.15 Egg Drop
		// 1.16 Longest Common Subsequence
		// 1.17 Longest palindromic Subsequence
		// 1.18 Edit Distance
		// 1.19 Knapsack
		// 1.20 Target Sum Problem
